...
export const dummyDateTimeData = {
    "2025-07-24": [
        { "movieId": 324544, "time": "2025-07-24T01:00:00.000Z", "showId": "68395b407f6329be2bb45bd1" },
        { "movieId": 1232546, "time": "2025-07-24T04:00:00.000Z", "showId": "68395b407f6329be2bb45bd2" },
        { "movieId": 552524, "time": "2025-07-24T06:30:00.000Z", "showId": "68395b407f6329be2bb45bd3" },
        { "movieId": 668489, "time": "2025-07-23T23:00:00.000Z", "showId": "68395b407f6329be2bb45bd4" },
        { "movieId": 324544, "time": "2025-07-24T02:30:00.000Z", "showId": "68395b407f6329be2bb45bd5" }
    ],
    "2025-07-25": [
        { "movieId": 950387, "time": "2025-07-25T01:00:00.000Z", "showId": "68395b407f6329be2bb45bd4" },
        { "movieId": 575265, "time": "2025-07-25T03:00:00.000Z", "showId": "68395b407f6329be2bb45bd5" },
        { "movieId": 986056, "time": "2025-07-25T05:00:00.000Z", "showId": "68395b407f6329be2bb45bd6" }
    ],
    "2025-07-26": [
        { "movieId": 324544, "time": "2025-07-26T01:00:00.000Z", "showId": "68395b407f6329be2bb45bd7" },
        { "movieId": 575265, "time": "2025-07-26T03:00:00.000Z", "showId": "68395b407f6329be2bb45bd8" },
        { "movieId": 986056, "time": "2025-07-26T05:00:00.000Z", "showId": "68395b407f6329be2bb45bd9" }
    ],
    "2025-07-27": [
        { "movieId": 1232546, "time": "2025-07-27T01:00:00.000Z", "showId": "68395b407f6329be2bb45bda" },
        { "movieId": 552524, "time": "2025-07-27T03:00:00.000Z", "showId": "68395b407f6329be2bb45bdb" },
        { "movieId": 668489, "time": "2025-07-27T05:00:00.000Z", "showId": "68395b407f6329be2bb45bdc" }
    ]
}

export const getDateTimeForMovie = (movieId) => {
    const selectedMovieId = String(movieId)

    return Object.entries(dummyDateTimeData).reduce((movieDateTime, [date, times]) => {
        const movieTimes = times.filter((item) => String(item.movieId) === selectedMovieId)
        if (movieTimes.length > 0) movieDateTime[date] = movieTimes
...
export const getMoviesForDate = (date) => {
    const movieIds = new Set((dummyDateTimeData[date] ?? []).map((item) => String(item.movieId)))

    return dummyShowsData.filter((movie) => (
        movieIds.has(String(movie.id)) || movieIds.has(String(movie._id))
    ))
}
